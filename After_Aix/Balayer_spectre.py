...
class Spectre(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Spectre")
        ...
        self._freq_center_range = qtgui.Range(start_f, 2000e6-15e6, samp_rate, start_f, 100)
...
def main(top_block_cls=Spectre, options=None):
