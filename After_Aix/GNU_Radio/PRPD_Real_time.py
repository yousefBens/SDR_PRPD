...
import time
import PRPD_Real_time_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class PRPD_Real_time(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PRPD_Real_time")
        ...
        self.qtgui_const_sink_x_0.set_y_axis((-70), 10)
    ...
    def get_freq_center_test(self):
        return self.freq_center_test
    ...
    def set_freq_center_p(self, freq_center_p):
        self.freq_center_p = freq_center_p
...
def main(top_block_cls=PRPD_Real_time, options=None):
